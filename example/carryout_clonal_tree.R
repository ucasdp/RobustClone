...
clones_vt <- new_variant_site(clone_gety, MST, 'CNV', 'parent') # obtain the CNV genome fragments of each subclone compared with its parent subclone or normal cell
