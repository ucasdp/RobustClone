...
clones_mt_change <- new_mutation(clone_gety, robust_clone, MST, 'SNV') # obtain the new SNV loci or CNV genome fragments of each subclone compared with its parent subclone