...
MST <- plot_MST(clone_gety, robust_clone, 'exampledata') # calculate and plot clonal MST
clones_mt_change <- new_mutation(clone_gety, robust_clone, MST) # get newly mutated genotypes of each subclone
